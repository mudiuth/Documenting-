relationship between the api software and the network 
benefits of network programability (simplified nentworking )



network innovation with programability 
today the network is a distributed system of single-purpose appliances that in most cases jas excess resources.
network programability unlocks these resources to solve bss problems and enhance the application experience.
network innovations helps organisations differentiate their products and solve problems using the network 
